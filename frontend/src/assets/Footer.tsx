        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center px-4 sm:px-6 lg:px-10 py-6 mt-12 bg-slate-950 gap-8 border-t border-slate-800">
            ...
            <div className="w-full lg:flex-2 flex gap-8">
                <div className="flex-1">
                    <div className="text-xs font-bold tracking-widest uppercase text-slate-400 mb-1">{t.footer.links}</div>
                    <div className="flex flex-col mt-2 gap-2 items-start">
                        <a href="#home" className={footerAnchor + " hover:text-blue-400 hover:translate-x-0.5 transition-all duration-200"}>{t.nav.home}</a>
                        <a href="#about" className={footerAnchor + " hover:text-blue-400 hover:translate-x-0.5 transition-all duration-200"}>{t.nav.about}</a>
                        <a href="#reviews" className={footerAnchor + " hover:text-blue-400 hover:translate-x-0.5 transition-all duration-200"}>{t.nav.reviews}</a>
                    </div>
                </div>

                <div className="flex-1">
                    <div>
                        <div className="text-xs font-bold tracking-widest uppercase text-slate-400 mb-1">{t.footer.marketplace}</div>
                    ...
                    <div>
                        <div className="text-xs font-bold tracking-widest uppercase text-slate-400 mb-1 mt-4">{t.footer.socialMedia}</div>
            ...
            <div className="w-full lg:flex-2 flex flex-col gap-4">
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                    <div className="flex-1">
                        <div className="text-xs font-bold tracking-widest uppercase text-slate-400 mb-1">{t.footer.contact}</div>
                        <div>
                    ...
                    <div className="flex-1">
                        <div className="text-xs font-bold tracking-widest uppercase text-slate-400 mb-1">{t.footer.address}</div>
                        <p className={footerAnchor}>
                            {t.footer.addressCountryCity}
                        </p>
                        <p className={footerAnchor}>
